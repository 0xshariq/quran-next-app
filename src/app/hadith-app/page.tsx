  ...
  return (
    <div className={`min-h-screen px-4 py-8 md:py-12 ${theme === 'dark' ? 'bg-gray-900' : 'bg-[#fff9e6]'}`}>
      <div className="max-w-7xl mx-auto">
        <h1 className={`text-4xl font-bold text-center mb-8 ${theme === 'dark' ? 'text-amber-300' : 'text-[#8B4513]'}`}>Hadith Explorer</h1>
        
        <div className="lg:flex lg:space-x-8 space-y-8 lg:space-y-0">
          <Card className={`${theme === 'dark' ? 'bg-gray-800' : 'bg-white'} shadow-lg border-0 lg:w-1/3`}>
          ...
          <div className="lg:w-2/3 space-y-8">
            ...
            {error && (
              <Alert className={`${theme === 'dark' ? 'bg-red-900 border-red-600 text-red-100' : 'bg-red-100 border-red-400 text-red-800'}`}>
